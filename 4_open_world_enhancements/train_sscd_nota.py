...
# to gain adversarial robustness, combined with
# Spike-and-Slab Concrete Dropout
#
...
# and we've also appended noise_fraction and alpha to this dictionary after tuning
        ...
        for trial in range(7, 10):
            ...
            for epoch in range(240):
                ...
                for x_train, y_train in train_loader:
                    ...
                    gaussian_prior_term = get_kl_loss(model) / (3 * len(x_train))
                    #print('Gaussian prior term', str(gaussian_prior_term.item()), end = ' ')
                    bernoulli_prior_term = model.bernoulli_kl_loss(representation + '_' + protocol) / (3 * len(x_train))
