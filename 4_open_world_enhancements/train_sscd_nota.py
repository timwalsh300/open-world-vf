...
for representation in ['dschuster16', 'schuster8']:
    #for protocol in ['https', 'tor']:
        ...
        #for eps_fraction in [0.01, 0.05, 0.1, 0.15]:
        #for eps_fraction in [0.0004, 0.0005, 0.0006]:
        # for pgd_steps in [5, 10, 20, 40]:
        #  for alpha in [0.05, 0.2]:
        #  for noise_fraction in [0.01, 0.05, 0.1, 0.15]:
        #  for noise_fraction in [0.005, 0.01, 0.05]:
