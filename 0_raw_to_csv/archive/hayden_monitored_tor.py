...
def parse(subdir):
    ...
    output_csv = open('/home/timothy.walsh/VF/hayden_monitored_tor/' + region + '_hayden_monitored_tor.csv', 'w')
            ...
            if filename == 'capture.pcap':
                ...
                try:
                    for timestamp, buf in input_pcap:
                        ...
                        conversations[distant_end].append(direction * ip.len)
                except:
                    print('bad pcap:', path)
                    continue
