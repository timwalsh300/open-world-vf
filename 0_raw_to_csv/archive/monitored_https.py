...
# max time to parse
MAX_TIME = 5.0
OUTPUT_DIR = '/home/timothy.walsh/VF/0_raw_to_csv/sirinam/monitored_https/'
...
def parse(subdir):
    files = 0
    region = REGION_RE.search(subdir).group()[:-6]
    output_csv = open(OUTPUT_DIR + region + '.csv', 'w')
...
#
# output is a set of .csv files to OUTPUT_DIR that bash can
# combine later with 'cat * > combined.csv'
