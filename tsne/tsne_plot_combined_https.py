...
df = pd.read_csv('/home/timothy.walsh/VF/tsne/schuster_combined_https_oregon_vimeo_animated.csv')
...
plt.savefig("/home/timothy.walsh/VF/tsne/tsne_plot_combined_https.png", dpi=300, bbox_inches='tight')
