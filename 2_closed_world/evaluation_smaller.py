...
# loads the model, hyperparameters, and dataset splits
# for sirinam_vf and and rahman and does the evaluation
# for Tor YouTube using 30% less training data to compare
# results with the ACM CCS poster by Rahman et al.
#
# output is the closed-world accuracy
...
results = {}
for representation in ['sirinam_vf', 'rahman']:
    for protocol in ['tor']:
